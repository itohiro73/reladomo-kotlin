package io.github.kotlinreladomo.generator.query
...
class QueryDslGenerator {
    ...
    companion object {
        private val predicateType = ClassName("io.github.kotlinreladomo.core.query", "Predicate")
        private val queryType = ClassName("io.github.kotlinreladomo.core.query", "Query")
    }
}