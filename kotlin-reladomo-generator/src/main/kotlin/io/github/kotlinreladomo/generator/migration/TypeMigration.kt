package io.github.kotlinreladomo.generator.migration
...
import io.github.kotlinreladomo.generator.model.ParsedMithraObject as EnhancedParsedMithraObject
...
object TypeMigration {
    ...
    fun migrateToEnhancedModel(old: MithraObjectDefinition): EnhancedParsedMithraObject {
        ...
        val objectType = when (old.objectType) {
            io.github.kotlinreladomo.generator.model.ObjectType.TRANSACTIONAL -> ObjectType.TRANSACTIONAL
            io.github.kotlinreladomo.generator.model.ObjectType.READ_ONLY -> ObjectType.READ_ONLY
            io.github.kotlinreladomo.generator.model.ObjectType.DATED_TRANSACTIONAL -> ObjectType.DATED_TRANSACTIONAL
            io.github.kotlinreladomo.generator.model.ObjectType.DATED_READ_ONLY -> {
