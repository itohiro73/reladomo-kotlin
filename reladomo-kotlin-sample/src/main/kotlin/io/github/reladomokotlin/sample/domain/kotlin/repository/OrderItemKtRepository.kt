...
import io.github.reladomokotlin.sample.domain.OrderItem
import io.github.reladomokotlin.sample.domain.OrderItemFinder
import io.github.reladomokotlin.sample.domain.kotlin.OrderItemKt
import io.github.reladomokotlin.sample.domain.kotlin.query.OrderItemQueryDsl
...
public class OrderItemKtRepository : BaseRepository<OrderItemKt, Long> {
  ...
  override fun findById(id: Long): OrderItemKt? {
    val entity = OrderItemFinder.findByPrimaryKey(id)
    return entity?.let { OrderItemKt.fromReladomo(it) }
  }
