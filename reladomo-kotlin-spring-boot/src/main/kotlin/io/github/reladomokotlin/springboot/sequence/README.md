...
This package provides comprehensive sequence generation support for Reladomo Kotlin applications, including integration with Reladomo's SimulatedSequence strategy.
...
4. **ClassNotFoundException for factory**: Ensure the reladomo-kotlin-spring-boot module is on the classpath