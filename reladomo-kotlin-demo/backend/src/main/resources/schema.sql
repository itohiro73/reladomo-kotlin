...
INSERT INTO PRODUCT_PRICES (ID, PRODUCT_ID, PRICE, UPDATED_BY, BUSINESS_FROM, BUSINESS_THRU, PROCESSING_FROM, PROCESSING_THRU) VALUES
(2, 1, 1000.00, 'pricing-team', '2025-06-30 15:00:00', '2025-10-31 15:00:00', '2025-09-30 15:00:00', '9999-12-01 00:00:00');
...
INSERT INTO PRODUCT_PRICES (ID, PRODUCT_ID, PRICE, UPDATED_BY, BUSINESS_FROM, BUSINESS_THRU, PROCESSING_FROM, PROCESSING_THRU) VALUES
(3, 1, 1200.00, 'alice@example.com', '2025-10-31 15:00:00', '9999-12-01 00:00:00', '2025-09-30 15:00:00', '2025-10-14 15:00:00');
...
INSERT INTO PRODUCT_PRICES (ID, PRODUCT_ID, PRICE, UPDATED_BY, BUSINESS_FROM, BUSINESS_THRU, PROCESSING_FROM, PROCESSING_THRU) VALUES
(4, 1, 1100.00, 'bob@example.com', '2025-10-31 15:00:00', '9999-12-01 00:00:00', '2025-10-14 15:00:00', '2025-10-19 15:00:00');
...
INSERT INTO PRODUCT_PRICES (ID, PRODUCT_ID, PRICE, UPDATED_BY, BUSINESS_FROM, BUSINESS_THRU, PROCESSING_FROM, PROCESSING_THRU) VALUES
(5, 1, 1100.00, 'bob@example.com', '2025-10-31 15:00:00', '2025-11-30 15:00:00', '2025-10-19 15:00:00', '9999-12-01 00:00:00');

-- ID 6: Charlie's 1250 - "From Oct 20 JST onwards, we know Dec 1 JST onwards is 1250"
INSERT INTO PRODUCT_PRICES (ID, PRODUCT_ID, PRICE, UPDATED_BY, BUSINESS_FROM, BUSINESS_THRU, PROCESSING_FROM, PROCESSING_THRU) VALUES
(6, 1, 1250.00, 'charlie@example.com', '2025-11-30 15:00:00', '9999-12-01 00:00:00', '2025-10-19 15:00:00', '9999-12-01 00:00:00');

-- Summer T-Shirt price by marketing team (Jun 1 JST = May 31 15:00 UTC)
INSERT INTO PRODUCT_PRICES (ID, PRODUCT_ID, PRICE, UPDATED_BY, BUSINESS_FROM, BUSINESS_THRU, PROCESSING_FROM, PROCESSING_THRU) VALUES
(7, 2, 29.99, 'marketing-team', '2025-05-31 15:00:00', '9999-12-01 00:00:00', '2025-05-31 15:00:00', '9999-12-01 00:00:00');

-- Programming Guide price by content team (Jul 1 JST = Jun 30 15:00 UTC)
INSERT INTO PRODUCT_PRICES (ID, PRODUCT_ID, PRICE, UPDATED_BY, BUSINESS_FROM, BUSINESS_THRU, PROCESSING_FROM, PROCESSING_THRU) VALUES
(8, 3, 49.99, 'content-team', '2025-06-30 15:00:00', '9999-12-01 00:00:00', '2025-06-30 15:00:00', '9999-12-01 00:00:00');
