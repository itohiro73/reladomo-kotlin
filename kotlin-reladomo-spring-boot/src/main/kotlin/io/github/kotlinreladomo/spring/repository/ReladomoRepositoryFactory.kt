...
import io.github.kotlinreladomo.spring.repository.query.QueryMethodParser
import io.github.kotlinreladomo.spring.repository.query.ReladomoQueryExecutor
...
class ReladomoRepositoryInvocationHandler(
    ...
    private data class ParsedQueryMethod(
        val parsedQuery: io.github.kotlinreladomo.spring.repository.query.ParsedQuery,
