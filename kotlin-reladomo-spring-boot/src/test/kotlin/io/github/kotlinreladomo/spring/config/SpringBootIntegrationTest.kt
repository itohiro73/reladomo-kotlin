...
import io.github.kotlinreladomo.spring.config.test.TestEntityRepository
...
@TestPropertySource(properties = [
    ...
    "reladomo.kotlin.repository.base-packages[0]=io.github.kotlinreladomo.spring.config.test",
...
class SpringBootIntegrationTest {
    ...
    fun `transaction manager is properly configured`() {
        ...
        assertTrue(transactionManager is io.github.kotlinreladomo.spring.transaction.ReladomoTransactionManager)
    }
    ...
    fun `properties are correctly loaded`() {
        ...
        assertTrue(properties.repository.basePackages.contains("io.github.kotlinreladomo.spring.config.test"))
    ...
    @EnableReladomoRepositories(basePackages = ["io.github.kotlinreladomo.spring.config.test"])
