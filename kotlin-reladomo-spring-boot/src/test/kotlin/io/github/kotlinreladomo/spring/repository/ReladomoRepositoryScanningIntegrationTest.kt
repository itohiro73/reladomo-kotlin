...
import io.github.kotlinreladomo.spring.config.ReladomoCacheConfiguration
import io.github.kotlinreladomo.spring.config.ReladomoDataSourceConfiguration
import io.github.kotlinreladomo.spring.repository.test.*
...
@EnableReladomoRepositories(
    basePackages = ["io.github.kotlinreladomo.spring.repository.test"]
)
