...
import io.github.kotlinreladomo.spring.scanner.EntityMetadata
import io.github.kotlinreladomo.spring.scanner.PropertyMetadata
...
class ReladomoProgrammaticConfigurationTest {
    ...
    fun `test generate runtime configuration XML`() {
        ...
        assertTrue(xml.contains("</MithraRuntime>"))
        assertTrue(xml.contains("<ConnectionManager className=\"io.github.kotlinreladomo.spring.connection.H2ConnectionManager\">"))
    ...
    fun `test connection manager class resolution`() {
        ...
        assertTrue(xml.contains("io.github.kotlinreladomo.spring.connection.H2ConnectionManager"))
    }
    ...
    fun `test configureMithraManager integration`() {
        ...
        val entities = listOf(
            EntityMetadata(
                className = "io.github.kotlinreladomo.test.TestEntity",
