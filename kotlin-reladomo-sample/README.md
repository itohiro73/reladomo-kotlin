...
```bash
./gradlew :kotlin-reladomo-sample:generateReladomoCode
```

This generates:
- Java Reladomo classes in `build/generated/reladomo/java`
- Kotlin wrapper classes in `src/main/kotlin/io/github/kotlinreladomo/sample/domain/kotlin`
- Repository classes in `src/main/kotlin/io/github/kotlinreladomo/sample/domain/kotlin/repository`

### 3. Build and Run

```bash
./gradlew :kotlin-reladomo-sample:build
