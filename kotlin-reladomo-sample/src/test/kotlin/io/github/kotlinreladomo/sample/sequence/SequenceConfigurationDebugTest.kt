package io.github.kotlinreladomo.sample.sequence

import io.github.kotlinreladomo.sequence.SequenceGenerator
import io.github.kotlinreladomo.springboot.sequence.SequenceAutoConfiguration
...
class SequenceConfigurationDebugTest {
    ...
    fun `debug sequence configuration`() {
        ...
        try {
            val reladomoAutoConfig = applicationContext.getBean("io.github.kotlinreladomo.spring.config.ReladomoKotlinAutoConfiguration")
