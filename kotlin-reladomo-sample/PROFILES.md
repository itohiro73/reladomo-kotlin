...
./gradlew :kotlin-reladomo-sample:bootRun --args='--spring.profiles.active=h2'
```
...
```bash
./gradlew :kotlin-reladomo-sample:bootRun --args='--spring.profiles.active=postgres'
```
...
./gradlew :kotlin-reladomo-sample:test --args='--spring.profiles.active=postgres'
```