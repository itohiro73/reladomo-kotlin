...
class QueryDslGeneratorTest {
    ...
    fun `test Query DSL generation for simple entity`(@TempDir tempDir: File) {
        ...
        // Verify imports
        assertTrue(content.contains("import io.github.reladomokotlin.query.QueryContext"))
        assertTrue(content.contains("import io.github.reladomokotlin.query.longAttribute"))
        assertTrue(content.contains("import io.github.reladomokotlin.query.stringAttribute"))
