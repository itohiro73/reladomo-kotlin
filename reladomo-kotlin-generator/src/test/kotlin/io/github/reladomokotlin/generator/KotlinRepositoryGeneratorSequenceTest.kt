...
import io.github.reladomokotlin.generator.model.ObjectType
...
class KotlinRepositoryGeneratorSequenceTest {
    ...
    fun `should generate repository with optional sequence generator`() {
        ...
        assertTrue(generatedCode.contains("import io.github.reladomokotlin.sequence.SequenceGenerator"))
